...
namespace InControl
{
	internal class TouchBuilder
	{
		...
		static void CreateTouchButtonControl()
		{			
			MonoBehaviour component;
			if (component = GameObject.FindObjectOfType<InControlManager>())
			{
				...
				control.buttonUpSprite = FindSpriteWithName( "TouchButton_A" );
				control.buttonDownSprite = FindSpriteWithName( "TouchButton_A" );
		...
		static void CreateTouchStickControl()
		{			
			MonoBehaviour component;
			if (component = GameObject.FindObjectOfType<InControlManager>())
			{
				...
				control.ringSprite = FindSpriteWithName( "TouchStick_Ring" );
				control.knobSprite = FindSpriteWithName( "TouchStick_Knob" );
		...
		static void CreateTouchSwipeControl()
		{			
			MonoBehaviour component;
			if (component = GameObject.FindObjectOfType<InControlManager>())
			{
		...
		static void CreateTouchTrackControl()
		{			
			MonoBehaviour component;
			if (component = GameObject.FindObjectOfType<InControlManager>())
			{
